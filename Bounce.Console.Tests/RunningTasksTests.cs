...
namespace Bounce.Console.Tests {
	...
	public class RunningTasksTests {
		...
		public void CanRunATask() {
			...
			FileSystemUtils.Pushd(@"..\..\..\TestBounceAssembly\bin\Debug", () => output = shell.Exec(@"..\..\..\Bounce.Console.Tests\bin\Debug\bounce.exe", "Task1"));
		...
		public void CanRunATaskWithArguments() {
			...
			FileSystemUtils.Pushd(@"..\..\..\TestBounceAssembly\bin\Debug", () => output = shell.Exec(@"..\..\..\Bounce.Console.Tests\bin\Debug\bounce.exe", "Task2 /a b"));
